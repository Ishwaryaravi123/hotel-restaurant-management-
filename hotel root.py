...
#creatinf label fram for controls 
 ...
 def reset(): # funtion to reset the different values specified in boxes 
         ...
         lblCond = Label(Menu, font=( 'aria' ,10 ),text="*Including all axes",fg="Black",bd=10,anchor='w',justify='right') 
...
usernameLabel = Label(logFrame, font=( 'aria' ,12, 'bold' ), text="User Name:",fg="Black",bd=10,anchor='w',justify='right', bg="white").grid(row=1, 
